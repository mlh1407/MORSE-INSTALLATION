/*
 * i denne version er der 2 lcd skærme på for forståelsens skyld
 * i denne version skriver begge displays text for forståelsens skyld
 * led strip sender ... og ikke prik streg prik er det ok ?
 * 
 */
